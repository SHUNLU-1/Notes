...
static const _BorrowMoney_Request_type_support_symbol_names_t _BorrowMoney_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, village_interfaces, srv, BorrowMoney_Request)),
...
static const _BorrowMoney_Response_type_support_symbol_names_t _BorrowMoney_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, village_interfaces, srv, BorrowMoney_Response)),
...
static const _BorrowMoney_type_support_symbol_names_t _BorrowMoney_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, village_interfaces, srv, BorrowMoney)),
