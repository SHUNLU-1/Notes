...
static const _SellNovel_Request_type_support_symbol_names_t _SellNovel_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, village_interfaces, srv, SellNovel_Request)),
...
static const _SellNovel_Response_type_support_symbol_names_t _SellNovel_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, village_interfaces, srv, SellNovel_Response)),
...
static const _SellNovel_type_support_symbol_names_t _SellNovel_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, village_interfaces, srv, SellNovel)),
