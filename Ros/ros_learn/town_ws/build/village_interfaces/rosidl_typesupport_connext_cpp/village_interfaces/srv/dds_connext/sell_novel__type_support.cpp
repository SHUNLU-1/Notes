  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const village_interfaces::srv::SellNovel_Request & ros_message =
    *(const village_interfaces::srv::SellNovel_Request *)untyped_ros_message;

  // create a respective connext dds type
  village_interfaces::srv::dds_::SellNovel_Request_ * dds_message = village_interfaces::srv::dds_::SellNovel_Request_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  village_interfaces::srv::SellNovel_Request & ros_message =
    *(village_interfaces::srv::SellNovel_Request *)untyped_ros_message;
...
{
  return &village_interfaces::srv::typesupport_connext_cpp::_SellNovel_Request__handle;
}
  ...
  village_interfaces::srv::dds_::SellNovel_Response_ & dds_message)
{
  // member.name novels
  {
    ...
    for (size_t i = 0; i < size; i++) {
      DDS_String_free(dds_message.novels_[static_cast<DDS_Long>(i)]);
      dds_message.novels_[static_cast<DDS_Long>(i)] =
        DDS_String_dup(ros_message.novels[i].c_str());
    }
  }
  ...
  village_interfaces::srv::SellNovel_Response & ros_message)
{
  // member.name novels
  {
    size_t size = dds_message.novels_.length();
    ros_message.novels.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros_message.novels[i] =
        dds_message.novels_[static_cast<DDS_Long>(i)];
    }
  }
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  // cast the untyped to the known ros message
  const village_interfaces::srv::SellNovel_Response & ros_message =
    *(const village_interfaces::srv::SellNovel_Response *)untyped_ros_message;

  // create a respective connext dds type
  village_interfaces::srv::dds_::SellNovel_Response_ * dds_message = village_interfaces::srv::dds_::SellNovel_Response_TypeSupport::create_data();
  if (!dds_message) {
    return false;
  }
  ...
  void * untyped_ros_message)
{
  ...
  village_interfaces::srv::SellNovel_Response & ros_message =
    *(village_interfaces::srv::SellNovel_Response *)untyped_ros_message;
  bool success = convert_dds_message_to_ros(*dds_message, ros_message);
  if (village_interfaces::srv::dds_::SellNovel_Response_TypeSupport::delete_data(dds_message) != DDS_RETCODE_OK) {
    return false;
  }
...
{
  return &village_interfaces::srv::typesupport_connext_cpp::_SellNovel_Response__handle;
}
...
void * create_requester__SellNovel(
...
const char * destroy_requester__SellNovel(
...
int64_t send_request__SellNovel(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  using ROSRequestType = village_interfaces::srv::SellNovel_Request;
  using RequesterType = connext::Requester<
    village_interfaces::srv::dds_::SellNovel_Request_,
    village_interfaces::srv::dds_::SellNovel_Response_
  >;
  connext::WriteSample<
    village_interfaces::srv::dds_::SellNovel_Request_> request;
...
void * create_replier__SellNovel(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
...
const char * destroy_replier__SellNovel(
  ...
  void * untyped_ros_response)
{
  using RequesterType = connext::Requester<
    ...
    village_interfaces::srv::dds_::SellNovel_Response_
  >;
  using ROSResponseType = village_interfaces::srv::SellNovel_Response;
...
{
  using ROSResponseType = const village_interfaces::srv::SellNovel_Response;
  using ReplierType = connext::Replier<
    village_interfaces::srv::dds_::SellNovel_Request_,
    village_interfaces::srv::dds_::SellNovel_Response_
  >;
...
{
  return &village_interfaces::srv::typesupport_connext_cpp::_SellNovel__handle;
}
