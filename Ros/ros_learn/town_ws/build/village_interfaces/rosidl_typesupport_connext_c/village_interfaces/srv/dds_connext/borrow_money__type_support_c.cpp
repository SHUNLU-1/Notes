...
#include "village_interfaces/srv/borrow_money__rosidl_typesupport_connext_c.h"
...
static DDS_TypeCode *
_BorrowMoney_Request__get_type_code()
{
  return village_interfaces::srv::dds_::BorrowMoney_Request_TypeSupport::get_typecode();
}

static bool
_BorrowMoney_Request__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  ...
  const village_interfaces__srv__BorrowMoney_Request * ros_message =
    static_cast<const village_interfaces__srv__BorrowMoney_Request *>(untyped_ros_message);
  village_interfaces::srv::dds_::BorrowMoney_Request_ * dds_message =
    static_cast<village_interfaces::srv::dds_::BorrowMoney_Request_ *>(untyped_dds_message);
  // Member name: name
  {
...
static bool
_BorrowMoney_Request__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const village_interfaces::srv::dds_::BorrowMoney_Request_ * dds_message =
    static_cast<const village_interfaces::srv::dds_::BorrowMoney_Request_ *>(untyped_dds_message);
  village_interfaces__srv__BorrowMoney_Request * ros_message =
    static_cast<village_interfaces__srv__BorrowMoney_Request *>(untyped_ros_message);
  // Member name: name
  {
...
static bool
_BorrowMoney_Request__to_cdr_stream(
  ...
  rcutils_uint8_array_t * cdr_stream)
{
  ...
  const village_interfaces__srv__BorrowMoney_Request * ros_message =
    static_cast<const village_interfaces__srv__BorrowMoney_Request *>(untyped_ros_message);
  village_interfaces::srv::dds_::BorrowMoney_Request_ dds_message;
  if (!_BorrowMoney_Request__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
...
static bool
_BorrowMoney_Request__to_message(
  ...
  void * untyped_ros_message)
{
  ...
  bool success = _BorrowMoney_Request__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _BorrowMoney_Request__callbacks = {
  ...
  "BorrowMoney_Request",  // message_name
  _BorrowMoney_Request__get_type_code,  // get_type_code
  _BorrowMoney_Request__convert_ros_to_dds,  // convert_ros_to_dds
  _BorrowMoney_Request__convert_dds_to_ros,  // convert_dds_to_ros
  _BorrowMoney_Request__to_cdr_stream,  // to_cdr_stream
  _BorrowMoney_Request__to_message  // to_message
};
...
static DDS_TypeCode *
_BorrowMoney_Response__get_type_code()
{
  return village_interfaces::srv::dds_::BorrowMoney_Response_TypeSupport::get_typecode();
}

static bool
_BorrowMoney_Response__convert_ros_to_dds(const void * untyped_ros_message, void * untyped_dds_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const village_interfaces__srv__BorrowMoney_Response * ros_message =
    static_cast<const village_interfaces__srv__BorrowMoney_Response *>(untyped_ros_message);
  village_interfaces::srv::dds_::BorrowMoney_Response_ * dds_message =
    static_cast<village_interfaces::srv::dds_::BorrowMoney_Response_ *>(untyped_dds_message);
  // Member name: success
  {
...
static bool
_BorrowMoney_Response__convert_dds_to_ros(const void * untyped_dds_message, void * untyped_ros_message)
{
  if (!untyped_ros_message) {
    fprintf(stderr, "ros message handle is null\n");
    return false;
  ...
  const village_interfaces::srv::dds_::BorrowMoney_Response_ * dds_message =
    static_cast<const village_interfaces::srv::dds_::BorrowMoney_Response_ *>(untyped_dds_message);
  village_interfaces__srv__BorrowMoney_Response * ros_message =
    static_cast<village_interfaces__srv__BorrowMoney_Response *>(untyped_ros_message);
  // Member name: success
  {
...
static bool
_BorrowMoney_Response__to_cdr_stream(
  const void * untyped_ros_message,
  rcutils_uint8_array_t * cdr_stream)
{
  if (!untyped_ros_message) {
  ...
  const village_interfaces__srv__BorrowMoney_Response * ros_message =
    static_cast<const village_interfaces__srv__BorrowMoney_Response *>(untyped_ros_message);
  village_interfaces::srv::dds_::BorrowMoney_Response_ dds_message;
  if (!_BorrowMoney_Response__convert_ros_to_dds(ros_message, &dds_message)) {
    return false;
  }
...
static bool
_BorrowMoney_Response__to_message(
  const rcutils_uint8_array_t * cdr_stream,
  void * untyped_ros_message)
{
  if (!cdr_stream) {
  ...
  bool success = _BorrowMoney_Response__convert_dds_to_ros(dds_message, untyped_ros_message);
...
static message_type_support_callbacks_t _BorrowMoney_Response__callbacks = {
  "village_interfaces::srv",  // message_namespace
  "BorrowMoney_Response",  // message_name
  _BorrowMoney_Response__get_type_code,  // get_type_code
  _BorrowMoney_Response__convert_ros_to_dds,  // convert_ros_to_dds
  _BorrowMoney_Response__convert_dds_to_ros,  // convert_dds_to_ros
  _BorrowMoney_Response__to_cdr_stream,  // to_cdr_stream
  _BorrowMoney_Response__to_message  // to_message
};
...
static void * create_requester__BorrowMoney(
...
{
  return village_interfaces::srv::typesupport_connext_cpp::create_requester__BorrowMoney(
    untyped_participant,
    request_topic_str,
    response_topic_str,
...
static const char * destroy_requester__BorrowMoney(
  void * untyped_requester,
  void (* deallocator)(void *))
{
  return village_interfaces::srv::typesupport_connext_cpp::destroy_requester__BorrowMoney(
    untyped_requester, deallocator);
}

static int64_t send_request__BorrowMoney(
  void * untyped_requester,
  const void * untyped_ros_request)
{
  ...
  >;
  connext::WriteSample<village_interfaces::srv::dds_::BorrowMoney_Request_> request;
...
static void * create_replier__BorrowMoney(
  void * untyped_participant,
  const char * request_topic_str,
  const char * response_topic_str,
  const void * untyped_datareader_qos,
  ...
  void * (*allocator)(size_t))
{
  return village_interfaces::srv::typesupport_connext_cpp::create_replier__BorrowMoney(
    untyped_participant,
    request_topic_str,
    response_topic_str,
    untyped_datareader_qos,
...
static const char * destroy_replier__BorrowMoney(
  void * untyped_replier,
  void (* deallocator)(void *))
{
  return village_interfaces::srv::typesupport_connext_cpp::destroy_replier__BorrowMoney(
    untyped_replier, deallocator);
}

static bool take_request__BorrowMoney(
  void * untyped_replier,
...
static bool take_response__BorrowMoney(
  void * untyped_requester,
  rmw_service_info_t * request_header,
...
{
  return village_interfaces::srv::typesupport_connext_cpp::get_request_datawriter__BorrowMoney(
    untyped_requester);
}
...
{
  return village_interfaces::srv::typesupport_connext_cpp::get_reply_datareader__BorrowMoney(
    untyped_requester);
}
...
{
  return village_interfaces::srv::typesupport_connext_cpp::get_request_datareader__BorrowMoney(
    untyped_replier);
}
...
{
  return village_interfaces::srv::typesupport_connext_cpp::get_reply_datawriter__BorrowMoney(
    untyped_replier);
}
...
static rosidl_service_type_support_t _BorrowMoney__type_support = {
  rosidl_typesupport_connext_c__identifier,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(
  ...
  BorrowMoney)()
{
  return &_BorrowMoney__type_support;
}
